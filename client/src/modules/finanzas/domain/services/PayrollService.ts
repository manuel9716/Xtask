  ...
  async generatePayrollForPeriod(employees: Employee[], periodStart: Date, periodEnd: Date, userId: number): Promise<Payroll[]> {
    ...
    for (const employee of employees) {
      ...
      const payroll: InsertPayroll = {
        ...
        periodStart,
        periodEnd,
        grossSalary: salaryCalc.grossSalary.toString(),
        netSalary: salaryCalc.netSalary.toString(),
        deductions: salaryCalc.deductions.toString(),
        benefits: salaryCalc.benefits.toString(),
        taxes: salaryCalc.taxes.toString(),
        status: 'pending',
        createdBy: userId,
