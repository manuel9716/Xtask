...
async function checkAndSetupNominaTables() {
  try {
    ...
    console.log(`📊 Total de nóminas en la base de datos: ${totalNominas}`);
    ...
    if (totalNominas === 0) {
      ...
      console.log(`Total de empleados disponibles: ${totalEmpleados}`);
